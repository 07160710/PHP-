...
<title>在线学习系统</title>
<!-- BOOTSTRAP STYLES-->
<link href="/huangkaifeng/assets/css/bootstrap.css" rel="stylesheet" />
<!-- FONTAWESOME STYLES-->
<link href="/huangkaifeng/assets/css/font-awesome.css" rel="stylesheet" />
<!-- MORRIS CHART STYLES-->
<link href="/huangkaifeng/assets/js/morris/morris-0.4.3.min.css"
	rel="stylesheet" />
<!-- CUSTOM STYLES-->
<link href="/huangkaifeng/assets/css/custom.css" rel="stylesheet" />
<!-- GOOGLE FONTS-->
	...
	<div id="wrapper">
		<nav class="navbar navbar-default navbar-cls-top " role="navigation"
			...
			<div
				...
				考生名：
				<?=$userName?>&nbsp;&nbsp;<a href="/huangkaifeng/index.php"
					class="btn btn-danger ">首页</a>&nbsp;<a
					href="loginout.php" class="btn btn-danger ">退出登录</a>
			</div>
		</nav>
		<!-- /. NAV SIDE  -->
