			...
			<div class="col-md-6 col-md-offset-1">
				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<form role="form" action="insertclassscoredo.php" method='post'>
							...
							<div class="form-group input-group">
								<span class="input-group-addon"><i class="fa fa-tag">考试名称</i></span>
							...
							<div class="form-group input-group">
								<span class="input-group-addon"><i class="fa fa-tag"> 平时成绩&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</i></span>
